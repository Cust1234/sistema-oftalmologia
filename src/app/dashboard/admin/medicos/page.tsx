    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="ml-64 p-8">
        <div className="flex justify-between items-center mb-6">
          ...
          <Link
            href="/dashboard/admin/medicos/novo"
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="p-3 text-left">Nº Ordem</th>
            ...
            <tbody>
              {medicos.map((medico) => (
                <tr key={medico.id} className="border-t">
                  <td className="p-3">{medico.nome}</td>
                  <td className="p-3">{medico.especialidade}</td>
                  <td className="p-3">{medico.numeroOrdem}</td>
                  <td className="p-3">{medico.telefone}</td>
                  <td className="p-3">{medico.consultas?.length || 0}</td>
                  <td className="p-3">
                    <Link href={`/dashboard/admin/medicos/${medico.id}`} className="text-blue-600 hover:underline mr-3">
                      Ver
                    </Link>
                    <Link href={`/dashboard/admin/medicos/${medico.id}/editar`} className="text-green-600 hover:underline mr-3">
                      Editar
                    </Link>
                    <button onClick={() => handleDelete(medico.id)} className="text-red-600 hover:underline">
                      Eliminar
                    </button>
                  </td>
                </tr>
